...
public class ReligareProposal {
		...
		// Declare An Excel Work Book
			...
			public void CignaSalutationFill() throws Exception {

			try {
				test = extent.createTest("Click on drop down", "Drop Down should be selected");
				test.assignCategory("Religare Proposal");
				WebElement salutation = driver.findElement(uimap.getLocator("Salutation_religare"));
				salutation.click();
				WebElement salutationselect = driver.findElement(uimap.getLocator("Salutation_text_Mr"));
		...
		public void MobileNo() throws Exception {
			try {
				...
				mobileno.sendKeys(datafile.getData("Proposer_mobile_religare"));
				Thread.sleep(1000);
				TestNGResults.put("6", new Object[] { 5d, "Fill Mobile no in proposal page", "Mobile no should be filled", "Pass" });
				
				if (datafile.getData("Proposer_mobile_religare").equals("9873008200")) {
					test.pass(datafile.getData("Proposer_mobileno") + " is " + "correct");
				} else
					test.log(Status.FAIL, datafile.getData("Proposer_mobile_religare") + " is not " + "correct");
		...
		@Test(description = "Fill Address", priority = 6)
		public void AddressOne() throws Exception {
			...
			try {
				...
				Thread.sleep(1000);
				TestNGResults.put("7", new Object[] { 6d, "Click on Address Input box & fill Value", "Address should be filled", "Pass" });
				...
				test.log(Status.ERROR, e.getMessage());
				TestNGResults.put("7", new Object[] { 6d, "Click on Address Input box & fill Value", "Address should be filled", "Fail" });
				//Assert.assertTrue(false);
			}
		}
		@Test(description = "Fill Address", priority = 7)
		public void AddressTwo() throws Exception {
			...
			try {
				...
				Thread.sleep(1000);
				TestNGResults.put("8", new Object[] { 7d, "Click on Address Input box & fill Value", "Address should be filled", "Pass" });
				...
				test.log(Status.ERROR, e.getMessage());
				TestNGResults.put("8", new Object[] { 7d, "Click on Address Input box & fill Value", "Address should be filled", "Fail" });
				//Assert.assertTrue(false);
			}
		}
		@Test(description = "Fill Pincode", priority = 8)
		...
		@Test(description = "Click Save & Continue", priority = 9)
		public void ProposerSaveandContinue() throws Exception {
			...
			try {
				...
				savencontinue.click();
				Thread.sleep(1000);
				TestNGResults.put("10", new Object[] { 9d, "Click on Save & Continue Button", "Button should be clicked", "Pass" });
				...
				test.log(Status.ERROR, e.getMessage());
				TestNGResults.put("10", new Object[] { 9d, "Click on Save & Continue Button", "Button should be clicked", "Fail" });
				//Assert.assertTrue(false);
			}
		}
		@Test(description = "Fill Adult Profession From Drop Down", priority = 10)
		public void Profession() throws Exception {

			try {
				test = extent.createTest("Fill Adult Profession From Drop Down", "Profession should be selected");
				WebElement profession = driver.findElement(uimap.getLocator("Adult_Profession_text_field"));
				profession.click();
				WebElement professionSelect = driver.findElement(uimap.getLocator("Profession_DropDown_select_Religare"));
				professionSelect.click();
				Thread.sleep(1000);
				TestNGResults.put("11", new Object[] { 10d, "Fill Adult Profession From Drop Down", "Profession should be selected", "Pass" });
				...
				test.log(Status.ERROR, e.getMessage());
				TestNGResults.put("11", new Object[] { 10d, "Fill Adult Profession From Drop Down", "Profession should be selected", "Fail" });
				//Assert.assertTrue(false);
			}
		}
		@Test(description = "Fill Marital status of adult", priority = 11)
		public void AdultMaritalStatus() throws Exception {
			...
			try {
				...
				WebElement maritalstatusadult = driver.findElement(uimap.getLocator("Marital_Status_Adult_Religare"));
				maritalstatusadult.click();
				WebElement maritalstatusadultselect = driver.findElement(uimap.getLocator("Marital_Status_Adult_Select"));
				maritalstatusadultselect.click();
				Thread.sleep(1000);
				TestNGResults.put("12", new Object[] { 11d, "Fill Adult Marital status from drop down", "Marital Status should be filled", "Pass" });
				...
				test.log(Status.ERROR, e.getMessage());
				TestNGResults.put("12", new Object[] { 11d, "Fill Adult Marital status from drop down", "Marital Status should be filled", "Fail" });
				//Assert.assertTrue(false);
			}
		}
		@Test(description = "Fill Weight", priority = 12)
		public void AdultWeight() throws Exception {
			...
			try {
				...
				Thread.sleep(1000);
				TestNGResults.put("13", new Object[] { 12d, "Fill Adult Weight in input box", "Weight should be filled", "Pass" });
				...
				test.log(Status.ERROR, e.getMessage());
				TestNGResults.put("13", new Object[] { 12d, "Fill Adult Weight in input box", "Weight should be filled", "Fail" });
				//Assert.assertTrue(false);
			}
		}
		@Test(description = "Fill Height in Feet", priority = 13)
		public void AdultHeightFeet() throws Exception {
			...
			try {
				...
				Thread.sleep(1000);
				TestNGResults.put("14", new Object[] { 13d, "Fill Adult Height from dropdown", "Adult Height In Feet should be filled", "Pass" });
				...
				test.log(Status.ERROR, e.getMessage());
				TestNGResults.put("14", new Object[] { 13d, "Fill Adult Height from dropdown", "Adult Height In Feet should be filled", "Fail" });
				//Assert.assertTrue(false);
			}
		}
		@Test(description = "Fill Height in inches", priority = 14)
		public void AdultHeightInches() throws Exception {
			...
			try {
				...
				Thread.sleep(1000);
				TestNGResults.put("15", new Object[] { 14d, "Fill Adult Height from dropdown", "Adult Height In inches should be filled", "Pass" });
				...
				test.log(Status.ERROR, e.getMessage());
				TestNGResults.put("15", new Object[] { 14d, "Fill Adult Height from dropdown", "Adult Height In inches should be filled", "Fail" });
				//Assert.assertTrue(false);
			}
		}
		@Test(description = "Fill Child Salutation", priority = 15)
		public void ChildSalutation() throws Exception {
			...
			try {
				...
				WebElement childsalutation = driver.findElement(uimap.getLocator("Child_salution_Religare"));
				childsalutation.click();
				WebElement childsalutationselect = driver.findElement(uimap.getLocator("Child_Salutation_Select"));
				childsalutationselect.click();
				Thread.sleep(1000);
				TestNGResults.put("16", new Object[] { 15d, "Fill Child Salutation from dropdown", "Child Salutation should be filled", "Pass" });
				
				if (uimap.getLocator("Child_Salutation_Select").equals("Mr.")) {
					test.pass(uimap.getLocator("Child_Salutation_Select") + " is " + "Correct");
					test.log(Status.INFO, "Snapshot" + test.addScreenCaptureFromPath("./1.jpg"));
				}

				else
					test.log(Status.FAIL, uimap.getLocator("Child_Salutation_Select") + " is not " + "Correct");

			} catch (Exception e) {
				test.log(Status.ERROR, e.getMessage());
				TestNGResults.put("16", new Object[] { 15d, "Fill Child Salutation from dropdown", "Child Salutation should be filled", "Fail" });
				//Assert.assertTrue(false);
			}
		}
		@Test(description = "Fill Child First Name", priority = 16)
		public void ChildFirstName() throws Exception {
			...
			try {
				...
				Thread.sleep(1000);
				TestNGResults.put("17", new Object[] { 16d, "Fill Child First Name In Input Box", "Child First Name should be filled", "Pass" });
				...
				test.log(Status.ERROR, e.getMessage());
				TestNGResults.put("17", new Object[] { 16d, "Fill Child First Name In Input Box", "Child First Name should be filled", "Fail" });
				//Assert.assertTrue(false);
			}
		}
		@Test(description = "Fill Child Last Name", priority = 17)
		public void ChildLastName() throws Exception {
			...
			try {
				...
				Thread.sleep(1000);
				TestNGResults.put("18", new Object[] { 17d, "Fill Child Last Name In Input Box", "Child Last Name should be filled", "Pass" });
				...
				test.log(Status.ERROR, e.getMessage());
				TestNGResults.put("18", new Object[] { 17d, "Fill Child Last Name In Input Box", "Child Last Name should be filled", "Fail" });
				//Assert.assertTrue(false);
			}
		}
		@Test(description = "Fill Child DOB", priority = 18)
		public void ChildDOB() throws Exception {
			...
			try {
				...
				TestNGResults.put("19", new Object[] { 18d, "Enter value for DOB", "Value in numbers", "Pass" });
				...
				test.log(Status.ERROR, e.getMessage());
				TestNGResults.put("19", new Object[] { 18d, "Enter DOB detail", "Date of Birth", "Fail" });
				//Assert.assertTrue(false);
			}
		}
		@Test(description = "Fill Adult Profession From Drop Down", priority = 19)
		public void ProfessionChild() throws Exception {

			try {
				test = extent.createTest("Fill Adult Profession From Drop Down", "Profession should be selected");
				WebElement profession = driver.findElement(uimap.getLocator("Child_Profession_Religare"));
				profession.click();
				WebElement professionSelect = driver.findElement(uimap.getLocator("Child_Profession_Select"));
				professionSelect.click();
				Thread.sleep(1000);
				TestNGResults.put("20", new Object[] { 19d, "Fill Adult Profession From Drop Down", "Profession should be selected", "Pass" });
				
				if (uimap.getLocator("Child_Profession_Select").equals("Private Service")) {
					test.pass(uimap.getLocator("Child_Profession_Select") + " is " + "correct");
				} else
					test.log(Status.FAIL, uimap.getLocator("Child_Profession_Select") + " is not " + "correct");

			} catch (Exception e) {
				test.log(Status.ERROR, e.getMessage());
				TestNGResults.put("20", new Object[] { 19d, "Fill Adult Profession From Drop Down", "Profession should be selected", "Fail" });
				//Assert.assertTrue(false);
			}
		}
		@Test(description = "Fill Child Weight", priority = 20)
		...
		@Test(description = "Fill Height in Feet", priority = 21)
		...
		@Test(description = "Fill Height in inches", priority = 22)
		...
		@Test(description = "Click Save & continue button in member Details section", priority = 23)
		public void MemberSaveAndContinue() throws Exception {
			...
			try {
				...
				WebElement membersavendcontinue = driver.findElement(uimap.getLocator("MemberDetail_SaveandContinue_button"));
		...
		@Test(description = "Click Radio button in Medical History section", priority = 24)
		public void MedicalHistory() throws Exception {
			...
			try {
				...
				questionthree.click();
				Thread.sleep(1000);
				WebElement questionfour = driver.findElement(uimap.getLocator("MedicalHistory_question_four_no"));
				questionfour.click();
				Thread.sleep(1000);
				WebElement questionfive = driver.findElement(uimap.getLocator("MedicalHistory_question_five_no"));
				questionfive.click();
				Thread.sleep(1000);
		...
		@Test(description = "Click Save & Continue in Medical History section", priority = 25)
		public void MedicalHistorySaveAndContinue() throws Exception {
			...
			try {
				...
				Thread.sleep(1000);
				TestNGResults.put("27", new Object[] { 25d, "Click Save & Continue in Medical History section", "button should be clicked", "Pass" });
				...
				test.log(Status.ERROR, e.getMessage());
				TestNGResults.put("27", new Object[] { 25d, "Click Save & Continue in Medical History section", "button should be clicked", "Fail" });
				//Assert.assertTrue(false);
			}
		}
		@Test(description = "Fill Nominee Name", priority = 26)
		public void NomineeName() throws Exception {
			...
			try {
				...
				WebElement nomineename = driver.findElement(uimap.getLocator("Nominee_Name_religare"));
		...
		@Test(description = "Fill Nominee Relation", priority = 27)
		public void NomineeRelation() throws Exception {
			...
			try {
				...
				WebElement nomineerelation = driver.findElement(uimap.getLocator("Nominee_Relation_Religare"));
		...
		@Test(description = "Click on Proceed to proceed to payment", priority = 28)
		public void ProceedToPayment() throws Exception {

			try {
				test = extent.createTest("Click on Proceed to proceed to payment", "Proposal page should be redirect on payment gateway");
				WebElement ProceedToPaymentbutton = driver.findElement(uimap.getLocator("Religare_Proceed_to_Payment"));
				ProceedToPaymentbutton.click();
				Thread.sleep(1000);
				TestNGResults.put("29", new Object[] { 28d, "Click on Proceed to proceed to payment", "Proposal page should be redirect on payment gateway", "Pass" });
				...
				test.log(Status.ERROR, e.getMessage());
				TestNGResults.put("29", new Object[] { 28d, "Click on Proceed to proceed to payment", "Proposal page should be redirect on payment gateway", "Fail" });
				//Assert.assertTrue(false);
			}
		}
